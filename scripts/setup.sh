...
cd "$(dirname "$0")/.."
REPO=$(gh repo view --json nameWithOwner -q .nameWithOwner 2>/dev/null || echo "Project516/review-bot")
TOTAL_STAGES=7
...
step "GitHub App name: something unique, e.g. project516-review-bot. Homepage URL: https://github.com/$REPO"
