...
step "Repository permissions: Checks Read-only; Contents Read and write (only used to resolve review threads); Issues Read and write; Pull requests Read and write. (Metadata is added automatically.)"
